#!/bin/bash
# ============================================================================
# backup.sh — MariaDB 자동 백업 스크립트
#
# 사용법:
#   chmod +x backup.sh
#   ./backup.sh
#
# 자동화 (NAS Cron / Task Scheduler):
#   0 2 * * * /volume1/docker/family-diary/deploy/scripts/backup.sh
#   (매일 새벽 2시 실행)
# ============================================================================
...
BACKUP_DIR="/volume1/docker/family-diary/backups"
